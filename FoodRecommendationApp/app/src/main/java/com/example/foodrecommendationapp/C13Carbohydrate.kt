...
class C13Carbohydrate : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_c13_carbohydrate, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        val recyclerview: RecyclerView = view.findViewById(R.id.c13CarbohydrateRecycler)

        val carbohydrates = mutableListOf(Food(R.drawable.flax_seeds, "Flaxseeds"),
