...
class C9Vitamin : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_c9_vitamin, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        val recyclerview: RecyclerView = view.findViewById(R.id.c9VitaminRecycler)

        val vitamins = mutableListOf(Food(R.drawable.orange, "Oranges"),
